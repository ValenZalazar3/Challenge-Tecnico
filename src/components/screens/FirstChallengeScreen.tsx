      ...
      <div className="flex flex-col justify-center items-center h-screen">
        ...
        <div className="mb-16">
          ...
          <button
            ...
            onFocus={() => {}}
            className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-xl text-sm px-5 py-2.5 me-2 ml-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
          >
            Eliminar números
          </button>
          {state.numbers ? (
            <input
              ...
              value={`Tus números son: ${state.numbers}`}
              disabled
              readOnly
            ></input>
          ) : undefined}
        ...
        <div>
          ...
          />
          <button
            onClick={handleResetTargetSum}
            onFocus={() => {}}
            className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-xl text-sm px-5 py-2.5 me-2 mb-2 ml-4 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
          >
        ...
        <button
          type="submit"
          onFocus={() => {}}
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 me-2 mb-2 mt-10 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          Encontrar par
        </button>
